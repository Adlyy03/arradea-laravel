...
<div class="space-y-6 lg:space-y-12">
    ...
    <div class="flex flex-col lg:flex-row justify-between items-center lg:items-end gap-5 lg:gap-10 bg-white p-8 lg:p-10 lg:p-20 rounded-2xl lg:rounded-3xl lg:rounded-2xl lg:rounded-3xl lg:rounded-[4rem] shadow-sm border border-gray-100">
        <div class="max-w-2xl text-center lg:text-left">
            ...
            <p class="text-gray-500 text-base lg:text-lg font-medium leading-relaxed">Status: <span class="font-black text-{{ $order->status === 'done' ? 'green' : ($order->status === 'rejected' ? 'red' : 'amber') }}-600">{{ strtoupper($order->status) }}</span></p>
        </div>
    ...
    <div class="grid lg:grid-cols-3 gap-8">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl lg:rounded-3xl p-8 shadow-sm border border-gray-100">
                ...
                <div class="space-y-4">
                    @php
                        $statuses = ['pending' => 'Menunggu Konfirmasi', 'accepted' => 'Diterima Penjual', 'rejected' => 'Ditolak', 'done' => 'Selesai'];
                        $statusColors = ['pending' => 'amber', 'accepted' => 'blue', 'rejected' => 'red', 'done' => 'green'];
                    @endphp
