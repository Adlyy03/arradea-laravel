<?php $__env->startSection('title', 'Kelola Kategori Produk'); ?>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-5 py-4">
                            <div class="flex items-center gap-3">
                                <?php if($category->image && (strpos($category->image, '/') !== false || strpos($category->image, 'http') !== false)): ?>
                                    <img src="<?php echo e($category->image); ?>" alt="<?php echo e($category->name); ?>" class="w-10 h-10 rounded-xl object-cover">
                                <?php else: ?>
                                    <div class="w-10 h-10 rounded-xl flex items-center justify-center text-lg font-bold" style="background:rgba(114,191,119,.12);color:#72bf77">
                                        <?php echo e($category->image ?: substr($category->name, 0, 1)); ?>

                                    </div>
                                <?php endif; ?>
                                <div>
                                    <p class="text-sm font-bold text-gray-900"><?php echo e($category->name); ?></p>
                        ...
                        <td class="px-5 py-4">
                            <span class="text-sm font-bold text-gray-900"><?php echo e($category->products_count); ?></span>
                            <span class="text-xs text-gray-400">produk</span>
                        </td>
                        <td class="px-5 py-4">
                            <?php if($category->stores_data->count() > 0): ?>
                                <div class="space-y-1">
                                    <?php $__currentLoopData = $category->stores_data->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="flex items-center gap-2">
                                            <span class="text-xs font-medium text-gray-700">🏪 <?php echo e($store['store_name']); ?></span>
                                            <span class="text-xs text-gray-400">(<?php echo e($store['product_count']); ?>)</span>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($category->stores_data->count() > 3): ?>
                                        <p class="text-xs text-gray-400">+<?php echo e($category->stores_data->count() - 3); ?> toko lainnya</p>
                                    <?php endif; ?>
                                </div>
                            <?php else: ?>
                        ...
                        <td class="px-5 py-4">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <button type="button"
                                        onclick="openDeleteModal(<?php echo e($category->id); ?>, '<?php echo e(addslashes($category->name)); ?>', <?php echo e($category->products_count); ?>)"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div class="bg-white rounded-2xl border border-gray-100 p-5">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-black text-gray-900"><?php echo e($categories->count()); ?></p>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 p-5">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-black text-gray-900"><?php echo e($categories->where('is_featured', true)->count()); ?></p>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 p-5">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-black text-gray-900"><?php echo e($categories->sum('products_count')); ?></p>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\arradea-laravel\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>