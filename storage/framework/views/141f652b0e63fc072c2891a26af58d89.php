<?php $__env->startSection('title', 'Daftar Akun — Arradea'); ?>
...
<div class="min-h-[calc(100vh-64px)] flex items-center justify-center px-4 py-12">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            <a href="<?php echo e(url('/')); ?>" class="inline-flex items-center gap-2 mb-6">
                <img src="<?php echo e(asset('images/arradea.jpeg')); ?>" alt="Arradea" class="w-10 h-10 rounded-2xl object-cover shadow-lg shadow-green-300/30">
            ...
            <?php if($errors->any()): ?>
                <div class="mb-5 p-4 bg-red-50 border border-red-100 rounded-2xl">
                    <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <p class="text-red-600 text-sm font-medium"><?php echo e($error); ?></p>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            <?php endif; ?>

            <form id="register-form" method="POST" action="<?php echo e(route('register.post')); ?>" class="space-y-4">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="<?php echo e(old('name')); ?>" required autocomplete="name"
                        class="w-full h-12 bg-gray-50 border border-gray-200 rounded-xl px-4 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#72bf77]/40 focus:border-[#72bf77]/60 transition-all <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="tel" name="phone" id="phone" value="<?php echo e(old('phone')); ?>" required autocomplete="tel"
                        class="w-full h-12 bg-gray-50 border border-gray-200 rounded-xl px-4 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#72bf77]/40 focus:border-[#72bf77]/60 transition-all <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 bg-red-50 <?php unset($message);
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="password" name="password" id="password-input" required
                                class="w-full h-12 bg-gray-50 border border-gray-200 rounded-xl px-4 pr-10 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#72bf77]/40 focus:border-[#72bf77]/60 transition-all <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 bg-red-50 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <p class="text-center text-sm text-gray-500 mt-6">
                Sudah punya akun?
                <a href="<?php echo e(route('login')); ?>" class="font-bold text-[#72bf77] hover:text-[#3fa348] transition">Masuk sekarang</a>
            </p>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\arradea-laravel\resources\views/auth/register.blade.php ENDPATH**/ ?>