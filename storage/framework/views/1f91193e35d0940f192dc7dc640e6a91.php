<?php $__env->startSection('title', 'Profil Saya — Arradea'); ?>
...
<div class="max-w-5xl mx-auto space-y-6 fade-up">
    ...
    <div class="profile-header flex items-center justify-between">
        ...
        <span class="hidden sm:inline-flex items-center px-3 py-1.5 rounded-xl text-[10px] lg:text-xs font-black uppercase tracking-widest" style="<?php echo e($modeBadgeClass); ?>">
    ...
    <div class="profile-card rounded-2xl lg:rounded-3xl overflow-hidden shadow-lg">
        <div class="profile-avatar-section p-6 lg:p-8 border-b border-gray-100/60" style="background:linear-gradient(135deg,rgba(240,250,241,0.6),rgba(255,255,255,0.4))">
            <div class="flex items-center gap-3 lg:gap-5">
                ...
                <div>
                    <h2 class="profile-avatar-name text-xl lg:text-2xl font-black text-gray-900"><?php echo e(auth()->user()->name); ?></h2>
                    <p class="profile-avatar-phone text-xs lg:text-sm text-gray-500 mt-0.5 lg:mt-1 font-medium"><?php echo e(auth()->user()->phone); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="profile-info-section p-6 lg:p-8 space-y-4 lg:space-y-5">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-5">
                <div class="profile-info-card p-4 lg:p-5 rounded-xl lg:rounded-2xl border transition-all duration-300 hover:shadow-md" style="background:rgba(249,250,251,0.6);border-color:rgba(229,231,235,0.8)">
                    ...
                    <p class="profile-info-value text-sm lg:text-base font-bold text-gray-900"><?php echo e(auth()->user()->phone ?? '—'); ?></p>
                </div>
                ...
                <div class="profile-info-card p-4 lg:p-5 rounded-xl lg:rounded-2xl border transition-all duration-300 hover:shadow-md" style="background:rgba(249,250,251,0.6);border-color:rgba(229,231,235,0.8)">
                    ...
                    <span class="profile-mode-badge inline-flex items-center gap-1.5 lg:gap-2 px-2.5 lg:px-3 py-1 lg:py-1.5 rounded-lg lg:rounded-xl text-[10px] lg:text-xs font-black uppercase <?php echo e(auth()->user()->is_seller ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-600'); ?>">
                        <?php echo e(auth()->user()->is_seller ? '🏪 Seller + Buyer' : '🛒 Buyer'); ?>
                ...
                <div class="profile-info-card p-4 lg:p-5 rounded-xl lg:rounded-2xl border sm:col-span-2 transition-all duration-300 hover:shadow-md" style="background:rgba(240,250,241,0.4);border-color:rgba(114,191,119,0.2)">
                    ...
                    <p class="profile-info-value text-sm lg:text-base font-bold text-gray-900"><?php echo e(auth()->user()->store->name); ?></p>
                    <p class="text-xs lg:text-sm text-gray-500 mt-1">Status: <span class="font-bold" style="color:#72bf77"><?php echo e(auth()->user()->store->status ?? 'pending'); ?></span></p>
                </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <?php if(auth()->user()->canSwitchToSellerMode() && auth()->user()->role !== 'admin'): ?>
    <div class="profile-card rounded-2xl lg:rounded-3xl overflow-hidden shadow-lg">
        <div class="p-5 lg:p-8">
            ...
            <div class="flex items-center justify-between mb-4 lg:mb-5">
                ...
                <?php if (isset($component)) { $__componentOriginal879c59c773c274030d61cd9561d203f6 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal879c59c773c274030d61cd9561d203f6 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.mode-badge','data' => ['mode' => auth()->user()->getActiveMode()]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('mode-badge'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['mode' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(auth()->user()->getActiveMode())]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal879c59c773c274030d61cd9561d203f6)): ?>
<?php $attributes = $__attributesOriginal879c59c773c274030d61cd9561d203f6; ?>
<?php unset($__attributesOriginal879c59c773c274030d61cd9561d203f6); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal879c59c773c274030d61cd9561d203f6)): ?>
<?php $component = $__componentOriginal879c59c773c274030d61cd9561d203f6; ?>
<?php unset($__componentOriginal879c59c773c274030d61cd9561d203f6); ?>
<?php endif; ?>
            </div>
...
<?php endif; ?>
    ...
    <div class="profile-alert flex items-center justify-between p-5 lg:p-6 rounded-xl lg:rounded-2xl shadow-lg" style="background:rgba(245,158,11,0.08);border:1px solid rgba(245,158,11,0.2)">
        ...
        <a href="<?php echo e(route('seller.pending')); ?>" class="profile-alert-btn px-4 lg:px-5 py-2 lg:py-2.5 rounded-lg lg:rounded-xl text-xs lg:text-sm font-bold text-amber-700 hover:text-white transition-all duration-300 flex-shrink-0" style="background:rgba(245,158,11,0.15);border:1px solid rgba(245,158,11,0.3)">Cek Status</a>
    </div>
    <?php elseif(auth()->user()->seller_status === 'pending' && !auth()->user()->seller_otp_verified): ?>
    <div class="profile-alert flex items-center justify-between p-5 lg:p-6 rounded-xl lg:rounded-2xl shadow-lg" style="background:rgba(234,179,8,0.08);border:1px solid rgba(234,179,8,0.2)">
        ...
        <a href="<?php echo e(route('seller.verify-otp')); ?>" class="profile-alert-btn px-4 lg:px-5 py-2 lg:py-2.5 rounded-lg lg:rounded-xl text-xs lg:text-sm font-bold text-white transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg flex-shrink-0" style="background:linear-gradient(135deg,#72bf77,#4db85a)">Verifikasi</a>
    </div>
    <?php endif; ?>
    ...
    <div class="profile-quick-actions profile-card rounded-2xl lg:rounded-3xl p-5 lg:p-6 shadow-lg">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 lg:gap-4">
            ...
            <a href="<?php echo e(route('seller.dashboard')); ?>" class="action-card flex flex-col items-center gap-2 lg:gap-3 p-4 lg:p-5 rounded-xl lg:rounded-2xl text-center shadow-sm" style="background:rgba(240,250,241,0.6);border:1px solid rgba(114,191,119,0.15)">
                <span class="text-2xl lg:text-3xl">🏪</span>
                <span class="text-xs lg:text-sm font-bold text-gray-700">Dashboard Seller</span>
            </a>
            <?php endif; ?>
            <a href="<?php echo e(route('buyer.dashboard')); ?>" class="action-card flex flex-col items-center gap-2 lg:gap-3 p-4 lg:p-5 rounded-xl lg:rounded-2xl text-center shadow-sm" style="background:rgba(239,246,255,0.6);border:1px solid rgba(191,219,254,0.4)">
                <span class="text-2xl lg:text-3xl">🛍️</span>
                <span class="text-xs lg:text-sm font-bold text-gray-700">Dashboard Buyer</span>
            </a>
            <a href="<?php echo e(route('buyer.orders')); ?>" class="action-card flex flex-col items-center gap-2 lg:gap-3 p-4 lg:p-5 rounded-xl lg:rounded-2xl text-center shadow-sm" style="background:rgba(254,243,199,0.6);border:1px solid rgba(253,230,138,0.4)">
                <span class="text-2xl lg:text-3xl">📋</span>
                <span class="text-xs lg:text-sm font-bold text-gray-700">Pesanan Saya</span>
            </a>
            <a href="<?php echo e(route('buyer.products')); ?>" class="action-card flex flex-col items-center gap-2 lg:gap-3 p-4 lg:p-5 rounded-xl lg:rounded-2xl text-center shadow-sm" style="background:rgba(240,253,244,0.6);border:1px solid rgba(187,247,208,0.4)">
                <span class="text-2xl lg:text-3xl">🛒</span>
        ...
        <div class="profile-card rounded-2xl lg:rounded-3xl p-5 lg:p-6 shadow-lg">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div class="bg-white rounded-xl border border-gray-100 p-4">
                    <form method="POST" action="<?php echo e(route('profile.update')); ?>" class="space-y-3">
                        ...
                        <div>
                            ...
                            <input name="name" type="text" required value="<?php echo e(old('name', auth()->user()->name)); ?>" class="w-full rounded-lg border px-3 py-2 text-sm">
                        </div>

                        <div>
                            <label class="block text-xs font-bold text-gray-600 mb-1">Nomor HP</label>
                            <input name="phone" type="text" required value="<?php echo e(old('phone', auth()->user()->phone)); ?>" class="w-full rounded-lg border px-3 py-2 text-sm">
                        </div>
                ...
                <div class="bg-white rounded-xl border border-red-100 p-4">
                    ...
                    <form method="POST" action="<?php echo e(route('profile.destroy')); ?>" class="space-y-3" onsubmit="return confirm('Yakin hapus akun?');">
                        <?php echo csrf_field(); ?>
            ...
            <div class="flex flex-col gap-1">
                ...
                <?php if($isMobileSeller): ?>
                    ...
                    <a href="<?php echo e(route('seller.dashboard')); ?>"
                       class="flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-amber-50 transition group <?php echo e(request()->routeIs('seller.dashboard') ? 'bg-amber-50' : ''); ?>">
                    ...
                    <a href="<?php echo e(route('seller.products')); ?>"
                       class="flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-amber-50 transition <?php echo e(request()->routeIs('seller.products*') ? 'bg-amber-50' : ''); ?>">
                        <div class="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0" style="background:#fffbeb;">
                    ...
                    <a href="<?php echo e(route('seller.orders')); ?>"
                       class="flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-amber-50 transition <?php echo e(request()->routeIs('seller.orders*') ? 'bg-amber-50' : ''); ?>">
                        <div class="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0" style="background:#fffbeb;">
                    ...
                    <a href="<?php echo e(route('seller.messages')); ?>"
                       class="flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-amber-50 transition <?php echo e(request()->routeIs('seller.messages*') ? 'bg-amber-50' : ''); ?>">
                        <div class="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0" style="background:#fffbeb;">
                    ...
                    <a href="<?php echo e(route('seller.analytics')); ?>"
                       class="flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-amber-50 transition <?php echo e(request()->routeIs('seller.analytics*') ? 'bg-amber-50' : ''); ?>">
                        <div class="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0" style="background:#fffbeb;">
                    ...
                    <a href="<?php echo e(route('seller.settings')); ?>"
                       class="flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-amber-50 transition <?php echo e(request()->routeIs('seller.settings*') ? 'bg-amber-50' : ''); ?>">
                        <div class="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0" style="background:#fffbeb;">
                ...
                <a href="<?php echo e(route('buyer.dashboard')); ?>"
                   class="flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-blue-50 transition <?php echo e(request()->routeIs('buyer.dashboard') ? 'bg-blue-50' : ''); ?>">
                ...
                <a href="<?php echo e(route('buyer.products')); ?>"
                ...
                <a href="<?php echo e(route('buyer.cart')); ?>"
                   class="flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-blue-50 transition">
                    <div class="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0" style="background:#eff6ff;">
                    ...
                    <?php $cartCount = auth()->user()->carts->count(); ?>
                    <?php if($cartCount > 0): ?>
                        <span class="ml-auto bg-blue-500 text-white text-[10px] font-black px-2 py-0.5 rounded-full"><?php echo e($cartCount); ?></span>
                    <?php else: ?>
                        <svg class="w-4 h-4 text-gray-300 ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                    <?php endif; ?>
                </a>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\arradea-laravel\resources\views/profile.blade.php ENDPATH**/ ?>