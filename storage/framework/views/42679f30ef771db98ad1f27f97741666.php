...
<div class="space-y-5 fade-up">
        ...
        <div class="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-5">
            ...
            <div class="flex gap-3 w-full lg:w-auto">
                ...
                <div class="flex-1 lg:flex-none text-center px-5 py-3 rounded-2xl" style="background:rgba(59,130,246,.12);border:1px solid rgba(59,130,246,.2)">
                    <p class="text-2xl font-black text-blue-400"><?php echo e($orders->where('status','accepted')->count()); ?></p>
    ...
    <div class="flex gap-2 overflow-x-auto pb-1 scrollbar-none">
        ...
        <?php $__currentLoopData = ['pending'=>'⏳ Pending','accepted'=>'🔄 Diproses','shipped'=>'🚚 Dikirim','done'=>'✅ Selesai','rejected'=>'❌ Ditolak']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
