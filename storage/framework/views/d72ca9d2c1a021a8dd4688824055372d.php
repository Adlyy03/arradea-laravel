...
<aside 
    ...
    <div class="flex items-center justify-between px-3 lg:px-4 h-[56px] lg:h-[60px] flex-shrink-0 border-b border-white/10">
        <div class="flex items-center gap-2 lg:gap-3">
            <img src="<?php echo e(asset('images/arradea.jpeg')); ?>" alt="Arradea" class="w-9 lg:w-10 h-9 lg:h-10 rounded-xl object-cover shadow-lg flex-shrink-0">
    ...
    <div class="px-3 lg:px-3 pt-3 lg:pt-4 pb-2 lg:pb-2 flex-shrink-0">
        ...
        <div x-show="!sideOpen" class="flex justify-center">
            <img src="<?php echo e(asset('images/arradea.jpeg')); ?>" alt="Arradea" class="w-11 h-11 rounded-xl object-cover shadow-md">
        </div>
    </div>
