<?php $__env->startSection('title', 'Analytics - Arradea Seller'); ?>
<?php $__env->startSection('page_title', 'Analitik Toko'); ?>
...
<div class="space-y-6 lg:space-y-12">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-purple-600 p-8 lg:p-10 lg:p-20 rounded-2xl lg:rounded-3xl lg:rounded-2xl lg:rounded-3xl lg:rounded-[4rem] text-white overflow-hidden relative shadow-2xl">
        ...
        <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div>
                ...
                <p class="text-blue-200 text-sm font-bold mt-2">Periode aktif: <?php echo e($analytics['period_label'] ?? '7 Hari Terakhir'); ?></p>
            </div>
            <a href="<?php echo e(route('seller.analytics.export', $analyticsQuery)); ?>" class="px-6 py-4 bg-white text-blue-600 rounded-2xl font-black shadow-lg hover:bg-gray-50 hover:-translate-y-1 transition-all flex items-center gap-3">
    ...
    <form method="GET" action="<?php echo e(route('seller.analytics')); ?>" class="bg-white p-5 lg:p-8 rounded-2xl lg:rounded-3xl lg:rounded-[3rem] border border-gray-100 shadow-sm">
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-4 lg:gap-6 items-end">
            <div class="lg:col-span-2">
                ...
                <select name="range" id="analytics-range" class="w-full rounded-2xl border border-gray-200 bg-white px-4 py-3 text-sm font-bold focus:border-primary-600 focus:outline-none">
                    <option value="7d" <?php if(($analytics['range'] ?? '7d') === '7d'): echo 'selected'; endif; ?>>7 Hari Terakhir</option>
                    <option value="30d" <?php if(($analytics['range'] ?? '7d') === '30d'): echo 'selected'; endif; ?>>30 Hari Terakhir</option>
                    <option value="custom" <?php if(($analytics['range'] ?? '7d') === 'custom'): echo 'selected'; endif; ?>>Custom</option>
                </select>
            </div>

            <div id="analytics-start-date-group" class="<?php echo e(($analytics['range'] ?? '7d') === 'custom' ? '' : 'hidden'); ?>">
                <label class="block text-xs font-black uppercase tracking-widest text-gray-400 mb-2">Tanggal Mulai</label>
                <input type="date" name="start_date" value="<?php echo e($analytics['start_date'] ?? ''); ?>" class="w-full rounded-2xl border border-gray-200 bg-white px-4 py-3 text-sm font-bold focus:border-primary-600 focus:outline-none">
            </div>

            <div id="analytics-end-date-group" class="<?php echo e(($analytics['range'] ?? '7d') === 'custom' ? '' : 'hidden'); ?>">
                <label class="block text-xs font-black uppercase tracking-widest text-gray-400 mb-2">Tanggal Akhir</label>
                <input type="date" name="end_date" value="<?php echo e($analytics['end_date'] ?? ''); ?>" class="w-full rounded-2xl border border-gray-200 bg-white px-4 py-3 text-sm font-bold focus:border-primary-600 focus:outline-none">
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
        <div class="bg-white p-8 rounded-2xl lg:rounded-3xl lg:rounded-[3rem] shadow-sm border border-gray-100 space-y-4">
            ...
            <div>
                ...
                <h4 class="text-3xl font-black text-gray-900 leading-none"><?php echo e($analytics['total_products']); ?></h4>
            </div>
        </div>
        ...
        <div class="bg-white p-8 rounded-2xl lg:rounded-3xl lg:rounded-[3rem] shadow-sm border border-gray-100 space-y-4">
            ...
            <div>
                ...
                <h4 class="text-3xl font-black text-gray-900 leading-none">Rp <?php echo e(number_format($analytics['total_revenue'], 0, ',', '.')); ?></h4>
            </div>
        </div>
        ...
        <div class="bg-white p-8 rounded-2xl lg:rounded-3xl lg:rounded-[3rem] shadow-sm border border-gray-100 space-y-4">
            ...
            <div>
                ...
                <h4 class="text-3xl font-black text-gray-900 leading-none"><?php echo e($analytics['total_orders']); ?></h4>
            </div>
        </div>
        ...
        <div class="bg-white p-8 rounded-2xl lg:rounded-3xl lg:rounded-[3rem] shadow-sm border border-gray-100 space-y-4">
            ...
            <div>
                ...
                <h4 class="text-3xl font-black text-gray-900 leading-none"><?php echo e($analytics['orders_in_period']); ?></h4>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="bg-white p-8 rounded-2xl lg:rounded-3xl lg:rounded-[3rem] shadow-sm border border-gray-100">
            ...
            <h4 class="text-4xl font-black <?php echo e($analytics['growth_percent'] >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                <?php echo e($analytics['growth_percent'] >= 0 ? '+' : ''); ?><?php echo e(number_format($analytics['growth_percent'], 1, ',', '.')); ?>%
            </h4>
            <p class="text-sm font-bold text-gray-500 mt-2">
                Periode ini: Rp <?php echo e(number_format($analytics['this_period_revenue'], 0, ',', '.')); ?>

            </p>
            <p class="text-xs text-gray-400 mt-1">
                Periode sebelumnya: Rp <?php echo e(number_format($analytics['previous_period_revenue'], 0, ',', '.')); ?>
        ...
        <div class="bg-white p-8 rounded-2xl lg:rounded-3xl lg:rounded-[3rem] shadow-sm border border-gray-100">
            ...
            <h4 class="text-4xl font-black text-sky-600"><?php echo e(number_format($analytics['conversion_rate'], 1, ',', '.')); ?>%</h4>
            <p class="text-sm font-bold text-gray-500 mt-2">
                <?php echo e($analytics['completed_orders']); ?> dari <?php echo e($analytics['total_orders']); ?> pesanan selesai
            </p>
        </div>

        <div class="bg-white p-8 rounded-2xl lg:rounded-3xl lg:rounded-[3rem] shadow-sm border border-gray-100">
            <p class="text-xs font-black uppercase tracking-widest text-gray-400 mb-2">Average Order Value</p>
            <h4 class="text-4xl font-black text-orange-600">Rp <?php echo e(number_format($analytics['average_order_value'], 0, ',', '.')); ?></h4>
        ...
        <div class="bg-white p-5 lg:p-10 rounded-2xl lg:rounded-3xl lg:rounded-[3rem] shadow-sm border border-gray-100">
            ...
            <div class="space-y-6">
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-2xl font-black text-gray-900"><?php echo e($analytics['pending_orders']); ?></span>
                </div>
                <div class="flex justify-between items-center">
                    <div class="flex items-center gap-4">
                    ...
                    <span class="text-2xl font-black text-gray-900"><?php echo e($analytics['accepted_orders']); ?></span>
                </div>
                <div class="flex justify-between items-center">
                    <div class="flex items-center gap-4">
                    ...
                    <span class="text-2xl font-black text-gray-900"><?php echo e($analytics['completed_orders']); ?></span>
                </div>
                <div class="flex justify-between items-center">
                    <div class="flex items-center gap-4">
                    ...
                    <span class="text-2xl font-black text-gray-900"><?php echo e($analytics['rejected_orders']); ?></span>
                </div>
                <div class="flex justify-between items-center">
                    <div class="flex items-center gap-4">
                    ...
                    <span class="text-2xl font-black text-gray-900"><?php echo e($analytics['cancelled_orders']); ?></span>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="lg:col-span-2 bg-white p-5 lg:p-10 rounded-2xl lg:rounded-3xl lg:rounded-[3rem] shadow-sm border border-gray-100">
            <h3 class="text-2xl font-black text-gray-900 mb-6">Tren Pendapatan (<?php echo e($analytics['period_label'] ?? '7 Hari Terakhir'); ?>)</h3>
            <div class="h-72">
        ...
        <div class="bg-white p-5 lg:p-10 rounded-2xl lg:rounded-3xl lg:rounded-[3rem] shadow-sm border border-gray-100">
            ...
            <?php if(($analytics['top_products'] ?? collect())->isEmpty()): ?>
                <p class="text-sm font-bold text-gray-500">Belum ada data penjualan selesai untuk menampilkan produk terlaris.</p>
            <?php else: ?>
                <div class="space-y-4">
                    <?php $__currentLoopData = $analytics['top_products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rank => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="p-4 rounded-2xl border border-gray-100 bg-gray-50">
                            <div class="flex items-center justify-between gap-3">
                                <p class="text-sm font-black text-gray-900">#<?php echo e($rank + 1); ?> <?php echo e($item->product->name ?? 'Produk Dihapus'); ?></p>
                                <span class="text-xs font-black text-primary-700 bg-primary-100 px-3 py-1 rounded-full"><?php echo e((int) $item->total_qty); ?> item</span>
                            </div>
                            <p class="text-xs font-bold text-gray-500 mt-2"><?php echo e((int) $item->total_orders); ?> order · Rp <?php echo e(number_format((float) $item->total_revenue, 0, ',', '.')); ?></p>
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const labels = <?php echo json_encode($analytics['revenue_trend_labels'] ?? [], 15, 512) ?>;
        const values = <?php echo json_encode($analytics['revenue_trend_values'] ?? [], 15, 512) ?>;
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\arradea-laravel\resources\views/seller/analytics.blade.php ENDPATH**/ ?>