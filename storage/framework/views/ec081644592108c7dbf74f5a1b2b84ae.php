...
<a href="/admin/dashboard" class="sb-item <?php echo e(Request::is('admin/dashboard') ? 'sb-active' : ''); ?>">
    <span class="sb-icon">
...
<a href="<?php echo e(route('admin.users.index')); ?>" class="sb-item <?php echo e(Request::is('admin/users') ? 'sb-active' : ''); ?>">
    <span class="sb-icon">
...
<a href="<?php echo e(route('admin.categories.index')); ?>" class="sb-item <?php echo e(Request::is('admin/categories*') ? 'sb-active' : ''); ?>">
    <span class="sb-icon">
...
<a href="<?php echo e(route('admin.products.index')); ?>" class="sb-item <?php echo e(Request::is('admin/products*') ? 'sb-active' : ''); ?>">
    <span class="sb-icon">
...
<a href="<?php echo e(route('admin.users.verification')); ?>" class="sb-item <?php echo e(Request::is('admin/users-verification*') ? 'sb-active' : ''); ?>">
    ...
    <?php if($pendingCount > 0): ?>
        <span x-show="sideOpen" x-cloak class="sb-badge sb-badge-red"><?php echo e($pendingCount); ?></span>
    <?php endif; ?>
</a>

<a href="<?php echo e(route('admin.complaints.index')); ?>" class="sb-item <?php echo e(Request::is('admin/complaints*') ? 'sb-active' : ''); ?>">
    <span class="sb-icon" style="position:relative">
    ...
    <?php if($pendingComplaints > 0): ?>
        <span x-show="sideOpen" x-cloak class="sb-badge sb-badge-red"><?php echo e($pendingComplaints); ?></span>
    <?php endif; ?>
</a>
...
<a href="<?php echo e(route('admin.map-users')); ?>" class="sb-item <?php echo e(Request::is('admin/map-users*') ? 'sb-active' : ''); ?>">
    <span class="sb-icon">
...
<?php /**PATH C:\laragon\www\arradea-laravel\resources\views/components/sidebar/admin.blade.php ENDPATH**/ ?>