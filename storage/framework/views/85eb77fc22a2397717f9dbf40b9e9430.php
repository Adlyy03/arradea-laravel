<?php $__env->startSection('title', 'Masuk — Arradea'); ?>

<?php $__env->startSection('content'); ?>
<?php $captchaSiteKey = config('services.recaptcha.site_key'); ?>
...
<div class="min-h-[calc(100vh-64px)] flex items-center justify-center px-4 py-12">
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-3xl shadow-xl shadow-green-100/30 border border-green-100/50 p-8">
            ...
            <form id="login-form" method="POST" action="<?php echo e(route('login.post')); ?>" class="space-y-5">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="tel" name="phone" value="<?php echo e(old('phone')); ?>" required
                            class="w-full h-12 bg-gray-50 border border-gray-200 rounded-xl pl-10 pr-4 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#72bf77]/40 focus:border-[#72bf77]/60 transition-all placeholder-gray-300 <?php $__errorArgs = ['phone'];
...
unset($__errorArgs, $__bag); ?>"
                ...
                <div>
                    ...
                    <?php if($errors->has('captcha') || $errors->has('g-recaptcha-response')): ?>
                        <p class="text-xs text-red-500 mt-1.5"><?php echo e($errors->first('captcha') ?: $errors->first('g-recaptcha-response')); ?></p>
                    <?php endif; ?>
                </div>
                <?php endif; ?>
            ...
            <p class="text-center text-sm text-gray-500 mt-6">
                Belum punya akun?
                <a href="<?php echo e(route('register')); ?>" class="font-bold text-[#72bf77] hover:text-[#3fa348] transition">Daftar di sini</a>
            </p>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\arradea-laravel\resources\views/auth/login.blade.php ENDPATH**/ ?>