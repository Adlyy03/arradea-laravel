<?php $__env->startSection('title', 'Admin Dashboard — Arradea'); ?>
...
<div class="space-y-5 fade-up">
    ...
    <div class="relative overflow-hidden rounded-3xl p-6 lg:p-8 text-white" style="background:linear-gradient(135deg,#0f1a11 0%,#1e3a22 50%,#0f1a11 100%)">
        ...
        <div class="relative z-10 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            <div>
                ...
                <p class="text-white/50 text-sm mt-2"><?php echo e(now()->locale('id')->isoFormat('dddd, D MMMM Y')); ?></p>
            </div>
            <div class="grid grid-cols-2 gap-3">
                <div class="px-5 py-4 rounded-2xl text-center" style="background:rgba(114,191,119,.12);border:1px solid rgba(114,191,119,.2)">
                    ...
                    <p class="text-3xl font-black"><?php echo e($totalUsers); ?></p>
                </div>
                <div class="px-5 py-4 rounded-2xl text-center" style="background:rgba(114,191,119,.12);border:1px solid rgba(114,191,119,.2)">
                    <p class="text-[9px] uppercase tracking-widest font-black mb-1" style="color:#72bf77">Produk Aktif</p>
                    <p class="text-3xl font-black"><?php echo e($totalProducts); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div class="stat-card flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-3xl font-black text-gray-900"><?php echo e($totalSellers); ?></p>
        ...
        <div class="stat-card flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-3xl font-black text-gray-900"><?php echo e($totalBuyers); ?></p>
    ...
    <div class="bg-amber-50 border border-amber-200 rounded-2xl p-5">
        <div class="flex items-center gap-3 mb-4">
            ...
            <h3 class="font-black text-amber-800"><?php echo e($pendingTotal); ?> Aksi Perlu Perhatian</h3>
        </div>
        <div class="grid sm:grid-cols-2 gap-3">
            ...
            <div class="flex items-center justify-between p-3.5 bg-white rounded-xl border border-amber-100">
                <div>
                    ...
                    <p class="text-xs text-gray-500"><?php echo e($pendingVerif); ?> pendaftar menunggu</p>
                </div>
                <a href="<?php echo e(route('admin.verifications.index')); ?>" class="px-3 py-1.5 rounded-lg text-xs font-bold text-white" style="background:#72bf77">Review</a>
            </div>
            <?php endif; ?>
            <?php if($pendingSellerOtp > 0): ?>
            <div class="flex items-center justify-between p-3.5 bg-white rounded-xl border border-amber-100">
                <div>
                    <p class="text-sm font-bold text-gray-900">Upgrade Seller</p>
                    <p class="text-xs text-gray-500"><?php echo e($pendingSellerOtp); ?> pengajuan OTP</p>
                </div>
                <a href="<?php echo e(route('admin.verifications.index')); ?>" class="px-3 py-1.5 rounded-lg text-xs font-bold text-white" style="background:#72bf77">Review</a>
            </div>
            <?php endif; ?>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden">
        <div class="flex items-center justify-between px-5 py-4 border-b border-gray-50">
            ...
            <a href="<?php echo e(route('admin.users.index')); ?>" class="text-xs font-bold" style="color:#72bf77">Lihat Semua →</a>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <?php $isVerif = $u->accessCode && $u->accessCode->is_active; ?>
                    <tr class="hover:bg-gray-50/50 transition">
                        <td class="px-5 py-3.5">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 rounded-xl flex items-center justify-center text-xs font-black flex-shrink-0" style="background:rgba(114,191,119,.12);color:#3fa348"><?php echo e(strtoupper(substr($u->name,0,1))); ?></div>
                                <div>
                                    <p class="font-bold text-gray-900 text-sm"><?php echo e($u->name); ?></p>
                                    <p class="text-xs text-gray-400"><?php echo e($u->phone); ?></p>
                                </div>
                            </div>
                        </td>
                        <td class="px-5 py-3.5">
                            <span class="px-2.5 py-1 rounded-lg text-[10px] font-black uppercase <?php echo e($u->is_seller ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-600'); ?>">
                                <?php echo e($u->is_seller ? 'Seller' : 'Buyer'); ?>

                            </span>
                        </td>
                        <td class="px-5 py-3.5">
                            <span class="px-2.5 py-1 rounded-lg text-[10px] font-black uppercase <?php echo e($isVerif ? 'bg-green-100 text-green-700' : 'bg-amber-100 text-amber-700'); ?>">
                                <?php echo e($isVerif ? 'Verified' : 'Pending'); ?>

                            </span>
                        </td>
                        <td class="px-5 py-3.5 text-xs text-gray-500"><?php echo e($u->created_at->format('d M Y')); ?></td>
                    </tr>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\arradea-laravel\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>