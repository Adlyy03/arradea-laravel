...
<div class="p-4 sm:p-6 lg:p-8 space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl sm:text-3xl font-black text-gray-900">Edit Kategori</h1>
            <p class="text-sm text-gray-500 mt-1">Perbarui informasi kategori <?php echo e($category->name); ?></p>
        </div>
    </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-green-500 focus:ring-2 focus:ring-green-100 transition <?php $__errorArgs = ['slug'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                          placeholder="Deskripsi singkat tentang kategori ini"><?php echo e(old('description', $category->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <select id="parent_id" 
                        name="parent_id"
                        class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-green-500 focus:ring-2 focus:ring-green-100 transition <?php $__errorArgs = ['parent_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>>
                    ...
                    <div id="existingImagePreview">
                        ...
                        <img src="<?php echo e($category->image); ?>" alt="<?php echo e($category->name); ?>" class="w-32 h-32 object-cover rounded-lg">
                    </div>
                    <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div id="textTab" class="hidden">
                    <input type="text" 
                           id="image_text" 
                           name="image_text" 
                           value="<?php echo e(old('image_text', (strpos($category->image, '/') === false && strpos($category->image, 'http') === false) ? $category->image : '')); ?>"
                           class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-green-500 focus:ring-2 focus:ring-green-100 transition <?php $__errorArgs = ['image_text'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="number" 
                       ...
                       min="0"
                       class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-green-500 focus:ring-2 focus:ring-green-100 transition <?php $__errorArgs = ['sort_order'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-start gap-3">
                <input type="checkbox" 
                       ...
                       name="is_featured" 
                       value="1"
                       <?php echo e(old('is_featured', $category->is_featured) ? 'checked' : ''); ?>
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-start gap-3">
                ...
                <div class="text-sm text-blue-800">
                    <p class="font-bold">Kategori ini memiliki <?php echo e($category->products()->count()); ?> produk</p>
                    <p class="mt-1">Perubahan akan mempengaruhi semua produk dalam kategori ini</p>
                </div>
            </div>
            <?php endif; ?>
...
// Check if there's an existing image to determine which tab to show
const hasExistingImage = existingImagePreview !== null;
if (hasExistingImage) {
    tabText.click();
} else {
    tabFile.click();
...
function handleFileSelect(file) {
    ...
    reader.onload = (e) => {
        ...
        if (existingImagePreview) existingImagePreview.classList.add('hidden');
    };
...
removeImage.addEventListener('click', (e) => {
    ...
    if (existingImagePreview) existingImagePreview.classList.remove('hidden');
});
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\arradea-laravel\resources\views/admin/categories/edit.blade.php ENDPATH**/ ?>