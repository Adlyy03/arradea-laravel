    ...
    <div class="product-grid grid grid-cols-3 lg:grid-cols-6 gap-2 lg:gap-4">
        ...
        <div data-aos="fade-up" data-aos-delay="<?php echo e(($loop->index % 6) * 50); ?>" class="product-card group bg-white rounded-xl border border-gray-100 overflow-hidden hover:shadow-lg hover:shadow-green-100/40 hover:border-green-200/50 transition-all duration-300" data-product-id="<?php echo e($product->id); ?>">
            <div class="product-image-wrapper relative w-full aspect-square overflow-hidden bg-gray-50">
                ...
                <?php if($isDiscount): ?>
                    <span class="discount-badge absolute top-2 left-2 px-1.5 py-0.5 rounded-lg text-[9px] font-black text-white" style="background:#72bf77">-<?php echo e($product->discount_percent); ?>%</span>
                <?php endif; ?>
            ...
            <div class="product-content p-2 lg:p-3">
                ...
                <div class="price-row flex items-end justify-between mb-1.5 lg:mb-2">
                    <div>
                        <?php if($isDiscount): ?>
                            <p class="product-old-price text-[8px] lg:text-[9px] text-gray-400 line-through">Rp <?php echo e(number_format($product->price,0,',','.')); ?></p>
                            <p class="product-price font-black text-[10px] lg:text-sm leading-none" style="color:#72bf77">Rp <?php echo e(number_format($finalPrice,0,',','.')); ?></p>
                        <?php else: ?>
                            <p class="product-price font-black text-[10px] lg:text-sm leading-none text-gray-900">Rp <?php echo e(number_format($product->price,0,',','.')); ?></p>
                        <?php endif; ?>
                    </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\arradea-laravel\resources\views/buyer/products/index.blade.php ENDPATH**/ ?>