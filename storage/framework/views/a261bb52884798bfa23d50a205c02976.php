...
unset($__errorArgs, $__bag); ?>"
                          placeholder="Deskripsi singkat tentang kategori ini"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div id="textTab" class="hidden">
                    <input type="text" 
                           id="image_text" 
                           name="image_text" 
                           value="<?php echo e(old('image_text')); ?>"
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\arradea-laravel\resources\views/admin/categories/create.blade.php ENDPATH**/ ?>